...
export default function Header() {
  ...
  <div className="relative flex items-center justify-center px-6 py-6 min-h-[100px] border-b border-white/10">
    ...
    <div className="flex justify-center items-center space-x-8 px-6 py-4 min-h-[60px] border-t border-white/10 text-sm font-bold uppercase tracking-wide">
        <Link to="/equips" className="hover:text-gray-300">Equips</Link>
        <Link to="/club" className="hover:text-gray-300">El Club</Link>
        <Link to="/socis" className="hover:text-gray-300">Socis</Link>
        <Link to="/noticies" className="hover:text-gray-300">Notícies</Link>
        <Link to="/patrocinadors" className="hover:text-gray-300">Patrocinadors</Link>
        <Link to="/botiga" className="hover:text-gray-300">Botiga del Club</Link>
      </div>
    </header>
  );
}
